# 1. IMAGEN DE CONSTRUCCIÓN (SDK) - AHORA VERSIÓN 9.0
FROM mcr.microsoft.com/dotnet/sdk:9.0 AS build
WORKDIR /src

# 2. COPIAR ARCHIVOS (Asegúrate que coincidan con tus carpetas reales)
...
# 6. IMAGEN FINAL (RUNTIME) - AHORA VERSIÓN 9.0
...
# COPIAR CREDENCIALES (No olvides esto)
